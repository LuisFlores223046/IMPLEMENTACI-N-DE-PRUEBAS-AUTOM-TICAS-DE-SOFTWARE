...
class AppDynamicsJob(unittest.TestCase):
    ...
    def test_app_dynamics_job(self):
        ...
        driver.find_element_by_xpath("//div[@id='menu_button_container']/div/div/div").click()
        driver.find_element_by_id("react-burger-menu-btn").click()
        driver.get("https://www.saucedemo.com/inventory.html")
        driver.find_element_by_id("inventory_sidebar_link").click()
        driver.find_element_by_id("add-to-cart-sauce-labs-bolt-t-shirt").click()
        driver.get("https://www.saucedemo.com/cart.html")
        driver.find_element_by_link_text("2").click()
        driver.find_element_by_id("remove-sauce-labs-bolt-t-shirt").click()
        driver.get("https://www.saucedemo.com/inventory.html")
